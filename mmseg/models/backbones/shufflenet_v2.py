...
from mmseg.models.decode_heads.base_backbone import BaseBackbone
...
class ShuffleNetV2(BaseBackbone):
    ...
    def __init__(self,
        ...
        for i, num_blocks in enumerate(self.stage_blocks):
            if i > 1 :
                layer = self._make_layer(channels[i], num_blocks,fstride=2)
            else:
                layer = self._make_layer(channels[i], num_blocks, fstride=2)
    ...
    def _make_layer(self, out_channels, num_blocks, fstride=1):
