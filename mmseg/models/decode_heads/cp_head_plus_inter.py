...
class CPHeadPlusInter(BaseDecodeHead):
    ...
    def __init__(self,
                 ...
                 c1_channels=0,
                 **kwargs):
        super(CPHeadPlusInter, self).__init__(**kwargs)
    ...
    def forward(self, inputs): #inputs 基于in_index选择对应层的特征，通过transfrom_input选出来，inputs本身会把4层都传过来
        ...
        cp_outs = torch.cat([x,  inter_context], dim=1)
    ...
    def losses(self, seg_logit, seg_label):
        ...
        loss = dict()
        loss.update(super(CPHeadPlusInter, self).losses(seg_logit, seg_label))
